...
<div class="col-xl">
    ...
    <div class="card-body">
        <form id="pretForm" method="post" action="<%= request.getContextPath() %>/reservation/creer">
        <div class="mb-6">
        ...
        <div class="mb-4 row">
            ...
            <div class="col-md-10">
                <input class="form-control" name="dateCible" type="datetime-local" value="2021-06-18T12:30:00" id="html5-datetime-local-input">
                <%
        ...
        <div class="mb-6">
            <label class="form-label" for="basic-default-company">Commentaire</label>
            <input type="text" name="commentaire" class="form-control" id="basic-default-company">
        </div>
